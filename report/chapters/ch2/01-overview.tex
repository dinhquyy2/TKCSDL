...
\begin{table}[htbp]
    ...
    \begin{tabular}{|p{1cm}|p{7cm}|p{2.3cm}|p{2cm}|}
        ...
        \hline
        3.2 & Viết script DDL SQL Server (bảng, khóa, ràng buộc) & Phức tạp & 5 \\
        \hline
        ...
        \hline
        4.1 & Cài đặt SQL Server (Docker), chạy schema thật & Đơn giản & 2 \\
        \hline
        ...
        \hline
        5.3 & Quản lý GitHub (repo, Issues, Milestones) & Đơn giản & 2 \\
        \hline
