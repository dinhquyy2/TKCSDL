...
\begin{enumerate}
    ...
    \item \textbf{Cơ sở dữ liệu:} Script DDL SQL Server đầy đủ, cơ chế ràng buộc append-only cho sổ cái tồn kho, index tối ưu, dữ liệu mẫu (seed data) minh họa, và script kiểm tra tính toàn vẹn dữ liệu.
\end{enumerate}
