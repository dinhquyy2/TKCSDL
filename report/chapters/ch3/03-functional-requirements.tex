...
\end{figure}
\begin{imgnote}
📌 Hình 3 — Cần bổ sung hình: \texttt{Hinh\_03\_ERD\_OISM.png} — ERD đầy đủ thể hiện toàn bộ 20 thực thể, quan hệ (1-n, n-n), khóa chính/khóa ngoại. Xem chi tiết danh sách thực thể tại Chương~4, mục~4.2.
\end{imgnote}
