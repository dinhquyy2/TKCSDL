...
\begin{itemize}
    \begin{itemize}
    \item \textbf{UML Class Diagram cần vẽ lại:} Bản nháp đầu thiếu 8/20 bảng quan trọng, cần vẽ lại theo Entity Catalog (Chương~4, mục~4.2.1).
    \item \textbf{Use Case Diagram cần đối chiếu lại phân quyền:} Chưa khớp Bảng RBAC (mục~3.3.3.3).
    \item \textbf{Đặc tả API chưa đầy đủ:} Mới có khung mẫu, cần mở rộng đủ theo Chương~3.
...
\begin{itemize}
    ...
    \item \textbf{CI/CD \& Containerization đầy đủ:} Thiết lập pipeline GitHub Actions để tự động build, test và deploy khi hệ thống có Backend/Frontend hoàn chỉnh.
\end{itemize}
